...
специально применимых для программирования на 1C Enterprise на текущую дату.
...
Упорядочи по актуальности на текущую дату.
            """
...
Создай материалы в следующем формате НА РУССКОМ ЯЗЫКЕ, используя Markdown разметку:

### TUTORIAL
**Краткое введение в тему**
Подробное объяснение темы (3-4 абзаца), основные концепции, пошаговый план изучения.
...
• **GitHub репозитории:** [название проекта](URL)  
• **Статьи и руководства:** [название статьи](URL)
• **Дополнительные ресурсы:** [название](URL)

### COURSES
• **YouTube видео:** [канал - название видео](URL)
• **Онлайн курсы:** [платформа - название курса](URL)
• **Бесплатные курсы:** [платформа - название](URL)

### EXAMPLES
**Практические примеры:**

Включи конкретные примеры кода с пояснениями:
- Используй \\`\\`\\`python для блоков кода
- Добавь комментарии к коду
- Приведи 2-3 практических примера
- Объясни каждый пример
